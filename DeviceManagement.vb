...
Namespace WinUsbDemo
		 ...
		 As Boolean
			...
			Try
				...
				If (devBroadcastHeader.dbch_devicetype = DBT_DEVTYP_DEVICEINTERFACE) Then
					...
					stringSize = CInt((devBroadcastHeader.dbch_size - 32) / 2)
   ...
   As Boolean
            ...
            Try
                ...
                Do
                    ...
                    Else
                        ...
                        Marshal.WriteInt32(detailDataBuffer, CInt(IIf((IntPtr.Size = 4), 4 + Marshal.SystemDefaultCharSize, 8)))
        ...
        Friend Function FindSpecificDeviceFromGuid _
   (ByVal myGuid As System.Guid, _
   ByRef devicePathName As String, _
